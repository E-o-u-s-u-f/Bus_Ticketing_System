...
values
    ...
    (3, 'selim ahmed', '017-777-8888', 'lic-54321', null);
...
insert into admin (adminid, fullname, email, registernumber)
values
    (1, 'sofia akter', 'sofia.akter@example.com', 'adm-001'),
    (2, 'rahim uddin', 'rahim.uddin@example.com', 'adm-002');
...
insert into schedules (scheid, dtime, routesid, busid, fare, available)
values 
    (1, '2025-08-22 08:00:00', 101, 1, 500.00, 1),
    (2, '2025-08-22 10:00:00', 102, 2, 450.00, 0),
    (3, '2025-08-23 09:00:00', 103, 3, 600.00, 1);
